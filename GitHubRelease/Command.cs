namespace GitHubRelease
{
    ...
    internal static class Command
    {
        ...
        /// <summary>
        /// Retrieves the release notes for the specified release.
        /// </summary>
        /// <param name="repo">The repository name.</param>
        /// <param name="tag">The tag name for the release.</param>
        /// <param name="branch">The branch name for the release.</param>
        /// <param name="assetPath">The path to the asset associated with the release.</param>
        public static async Task GetReleaseNotes(string repo, string tag, string branch, string assetPath)
        {
        ...
        /// <param name="branch">The branch name for the release.</param>
        /// <param name="assetPath">The path to the asset associated with the release.</param>
        public static async Task UpdateRelease(string repo, string tag, string branch, string assetPath)
        {
            var releaseService = new ReleaseService(repo);
